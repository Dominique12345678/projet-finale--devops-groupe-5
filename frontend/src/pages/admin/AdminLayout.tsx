...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 flex-col md:flex-row">
      ...
      `}>
        <h2 className="hidden md:block text-2xl font-black text-blue-400 tracking-tighter text-center">TECHSHOP ADMIN</h2>
            ...
            return (
              <Link 
                ...
                className={`flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 group ${
                  isActive ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'hover:bg-white/10 text-gray-300'
                }`}
              >
